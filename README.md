...
해당 Step에서 항공드론 웹페이지의 DB를 통해 신청 시간을 확인하는 작업이 이루어집니다.
...
- 신청 시 **사용 시간을 지정**해야 하며, **승인된 시간 내에서만** GPU 사용이 가능합니다. 시간 종료 후에는 이슈 작성을 통한 GPU접근이 막히게 됩니다.
